...
opt.register('inputDir',  '/afs/cern.ch/work/p/pasenov/CMSSW_10_1_11/src/Geometry/PixelTelescope/test/RAW/run100368',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
	     'Directory of input raw files')

opt.register('outputFileName', 'PixelTelescope_BeamData_RAW_run100368_seeds_L1_L2_and_L2_L3_and_L3_L4_Dxmax_0.1_cm_Dymax_0.1_cm.root',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
	     'Name of output reco file')

opt.register('outputDQMFileName', 'PixelTelescope_BeamData_DQM_run100368_seeds_L1_L2_and_L2_L3_and_L3_L4_Dxmax_0.1_cm_Dymax_0.1_cm.root',
	     opts.VarParsing.multiplicity.singleton, opts.VarParsing.varType.string,
...
#process.DQMData = cms.EDAnalyzer('AnaNikkie', 
	...
	FirstSeedLayer = cms.int32(0),
	SecondSeedLayer = cms.int32(1),
	dxmax = cms.double(0.1),
	dymax = cms.double(0.1)
